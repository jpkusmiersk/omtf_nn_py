...
#model.add(layer2)
#model.add(layer3)
#model.add(tf.keras.layers.ActivityRegularization(l2=0.003))
...
model.fit(x_train, y_train, epochs=40, batch_size = 64*16, callbacks=callbacks, validation_split=0.2, shuffle=True) #
